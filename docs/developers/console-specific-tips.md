...
![nes_mem_mirror](/developers/images-consoletips/tips1.png)
...
![gb_echo_ram](/developers/images-consoletips/tips2.png)
...
![unineo1](/developers/images-consoletips/tips3.png)

**Here is how the same RAM region looks when other BIOS are used (here MSV):**
![unineo2](/developers/images-consoletips/tips4.png)
